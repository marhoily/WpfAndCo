...
namespace Generator.DataContext
{
    ...
    #line 1 "C:\srcroot\WpfAndCo\Generator\DataContext\Tracking.tt"
...
");
	...
	foreach (var type in _model.GetEntityTypes())
	{
            ...
            #line 19 "C:\srcroot\WpfAndCo\Generator\DataContext\Tracking.tt"
            ...
            #line 22 "C:\srcroot\WpfAndCo\Generator\DataContext\Tracking.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(type.ClrType.Name));
